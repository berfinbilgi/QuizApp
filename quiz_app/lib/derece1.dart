  ...
  Widget build(BuildContext context) {
    return Scaffold (
         backgroundColor: Color.fromRGBO( 133, 173, 210, 1),
          ...
          body: Column(
        children: [
          Expanded( flex: 2, child: Center(child: Text("Almanca" ,style: TextStyle(fontSize: 40, color: Color.fromARGB(255, 0, 0, 0)),)),),

          Center(child: Text("Almancayı Seçtin!" ,style: TextStyle(fontSize: 15, color: Color.fromARGB(255, 255, 255, 255),) )),
              ...
              children: [ 
                Expanded(child: Padding(
                  ...
                  child: ElevatedButton(style: ElevatedButton.styleFrom(primary: Color.fromARGB(65, 16, 0, 40) ),onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>  Quiz_almanca(), ));
                  }, child: Text("A1") ),
                )),
                Expanded(child: Padding(
                  padding: const EdgeInsets.all(7.0),
